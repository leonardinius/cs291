...
function drawGoldCube() {
	...
	cube.position.y = -20;	// centered at origin
	cube.position.z = 30;	// centered at origin
	scene.add(cube) ;
...
function init() {
	...
	scene.fog = new THREE.Fog( 0x809090, 1000, 6000 );
	// LIGHTS
	scene.add( new THREE.AmbientLight( 200000 ) );
